...
const Settings = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        // Set profile data with correct field mapping
        setProfile({
          full_name: fullName || localStorage.getItem("user_name") || "",
          phone_number: userData.phone_number || "",
          email: userData.email || userEmail || "",
          profile_picture: userData.profile_image || googlePicture || "",
        });
  ...
  const handleSaveClick = async () => {
    ...
    const sendData = {
      ...
      last_name: lastName,
      phone_number: profile.phone_number,
      profile_image: profile.profile_picture, // Use correct field name for API
    };
